      ...
      {store.education.map((x) => (
        <div grid gap-3>
          <div flex justify-between>
            <p pl-10 class="!m-0"underline>{x.institution}</p>
            <p class="!m-0" bg="slate-1 dark:black-4" p-1 px-2 rounded-lg>
              {x.duration}
            </p>
          </div>
          <li pl-15>{x.qualification}</li>
        </div>
      ))}
    </div>
  </div>
  ...
  <div grid gap-7>
    ...
    <div grid gap-3>
      {store["work experience"].map((x) => (
        <div grid gap-3>
          <div flex justify-between>
            <p pl-10 class="!m-0"  underline>{x.company}</p>
            <p class="!m-0" bg="slate-1 dark:black-4" p-1 px-2 rounded-lg>
              {x.duration}
            </p>
          </div>
          <li pl-15>{x.position}</li>
        </div>
      ))}
    </div>
  </div>
  ...
  <div grid gap-7 h-fit>
    ...
    <div flex flex-wrap gap-3>
      {store[props.store_name].map((x) => {
        ...
        return (
          <span
            class="vertCentered p-1 px-2 rounded-lg"
...
export default () => (
  ...
  >
    ...
    <h2
      class="text-center font-normal text-xl font-raleway"
